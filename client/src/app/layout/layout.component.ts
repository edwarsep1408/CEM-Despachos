...
const RUTAS_CATALOGO_CONFIG = [
  ...
  "/configuracion/despacho/localizaciones",
  ...
  grupos: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Localizaciones', icon: 'bx-map', route: '/configuracion/despacho/localizaciones', permisos: ['despacho.localizaciones', 'despacho.codigos-ean', 'despacho.ordenes-compra', 'items.ver'] },
